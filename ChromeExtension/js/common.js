...
function getWeek(){
	return Math.max(1,Math.min(17,Math.ceil(((new Date())-(new Date(2015,8,8)))/(1000*60*60*24*7))));
}
...
var TEAMS=["Ari", "Atl", "Bal", "Buf", "Car", "Chi", "Cin", "Cle", "Dal", "Den", "Det", "GB", "Hou", "Ind", "Jax", "KC", "Mia", "Min", "NE", "NO", "NYG", "NYJ", "Oak", "Phi", "Pit", "SD", "SF", "Sea", "StL", "TB", "Ten", "Was"];