...
namespace FantasyFootball.Terminal.Daily
{
    public class DailyModel3
    {
        ...
        public DailyModel3(SQLiteConnection connection, TextWriter output, FantasyProsClient fantasyProsClient)
        {
        ...
        private static Normal EstimateForDST(DstProjection projection) => Estimate(projection.FantasyPoints);
